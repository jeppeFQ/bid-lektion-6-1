...
1. Algoritmer
2. (OS'er: lagring af data, filhåndtering)
...
Det er med/gennem OS'et vi kan åbne en terminal/kommandoprompt og kører Python-fortolkeren når vi skriver `python3 script.py` og 
giver Python adgang til at læse/skrive filer på computeren. 
